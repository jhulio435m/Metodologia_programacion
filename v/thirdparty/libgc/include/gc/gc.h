...
typedef void (GC_CALLBACK * GC_same_obj_print_proc_t)(void *,
                                                      void *);
...
GC_API size_t GC_CALL GC_size(const void *);
...
GC_API int GC_CALL GC_toggleref_add(void *, int)
                                                GC_ATTR_NONNULL(1);
GC_API int GC_CALL GC_debug_toggleref_add(void *,
...
typedef void (GC_CALLBACK * GC_warn_proc)(const char *,
                                          GC_uintptr_t);
...
#ifdef GC_THREADS
  GC_API void * GC_CALL GC_call_with_reader_lock(GC_fn_type,
                                void *,
                                int) GC_ATTR_NONNULL(1);
#else
...
GC_API void GC_CALL GC_start_mark_threads(void);
  ...
  typedef void (GC_CALLBACK * GC_sp_corrector_proc)(void **,
                                                    void *);
